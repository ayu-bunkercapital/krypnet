var Token = artifacts.require("KrypNetwork");

contract('krypnetwork', function(accounts) {
  ...
  it("should return the name of the token", function() {
    ...
    return Token.deployed().then(function(instance){
      ...
      assert.equal(result, "Kryp Token", 'name is wrong');
    })
  });
  it("should return the symbol of the token", function() {
    ...
    return Token.deployed().then(function(instance){
      ...
      assert.equal(result, "KRYP", 'Symbol is wrong');
    })
  });
